  ...
  return (
    <>
      ...
      {showRoundClosingModal && (
        <div className="modal modal-open">
          <div className="modal-box">
            <h3 className="font-cubano text-3xl text-center mb-5">Round {roundNumber} Closing Soon</h3>
            <p className="text-center text-xl">
              You have ~30 seconds to allocate your funds before chainlink automation starts the request for random
              numbers that determine vault ROIs
            </p>
            <div className="modal-action">
